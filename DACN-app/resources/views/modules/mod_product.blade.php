    ...
    <div class="container">
        <div class="w3ls_dresses_grids">
            ...
            <div class="col-md-9 w3ls_dresses_grid_right">
                ...
                <div class="ds_san_pham"></div>
                <div class="pagination">
                    <button class="page-link" onclick="process_load_page(0)">First</button>
                    <button class="page-link" onclick="process_load_page_previous()">Previous</button>
                </div>
                <div class="pagination list_page"></div>
                <div class="pagination">
                    <button class="page-link" onclick="process_load_page_next()">Next</button>
                    <button class="page-link" onclick="process_load_page({{ $so_trang - 1 }})">Last</button>
                </div>
...
<script>
    ...
    function load_ajax_page(cur_page) {
        $.get('/product/pagination/' + cur_page)
            .then((data) => {
                //console.log(data);
                ...
                for (var i = 0; i < so_trang; i++) {
                    if (i >= cur_page - 5 && i <= cur_page + 5) {
                        html_list_page += `
                            <button class="page-link" onclick="process_load_page(${i})">${i + 1}</button>
                            `
                    }
                }
                ...
                if (data.ds_san_pham.length > 0) {
                    var html_ds_san_pham = '';

                    for (var i = 0; i < data.ds_san_pham.length; i++) {
                        html_ds_san_pham += `
                        <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
                        <div class="agile_ecommerce_tab_left dresses_grid ">
                                <div>
                                    <img src="images/hinh_sp/${data.ds_san_pham[i].hinh}" alt=" "
                                        class="img-responsive" />
                                </div>
                                <h5><a href="/single?id_sp=${data.ds_san_pham[i].ma_san_pham}">${data.ds_san_pham[i].ten_san_pham}</a></h5>
                                <div class="simpleCart_shelfItem">
                                    <p><span>$${data.ds_san_pham[i].don_gia}</span> <i class="item_price">$${data.ds_san_pham[i].gia_giam}</i></p>
                                    <p><a class="item_add" href="#">Add to cart</a></p>
                                </div>
                                </div>
                                </div>
                    ...
                    //console.log(html_ds_san_pham);
                    $('.ds_san_pham').html(html_ds_san_pham);
                }
            });
    }
