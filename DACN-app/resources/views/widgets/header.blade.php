                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <ul class="multi-column-dropdown">
                                        <h6>Clothing</h6>
                                        <li><a href="dresses.html">TANK TOP<span>New</span></a></li>
                                        <li><a href="sweaters.html">JERSEY</a></li>
                                        <li><a href="skirts.html">Shorts </a></li>
                                        <li><a href="jeans.html">JACKETS/HOODIES/SWEATER</a></li>
                                        <li><a href="shirts.html">T-Shirts<span>New</span></a></li>
                                    </ul>
                                </div>
                                <div class="col-sm-3">
                                    <ul class="multi-column-dropdown">
                                        <h6>ACCESSORIES</h6>
                                        <li><a href="salwars.html">BASKETBALL SOCKS</a></li>
                                        <li><a href="sarees.html">BACKPACKS<span>New</span></a></li>
                                        <li><a href="products.html"><i>BALL</i></a></li>
                                    </ul>
                                </div>
                                <div class="col-sm-2">
                                    <ul class="multi-column-dropdown">
                                        <h6>Foot Wear</h6>
                                        <li><a href="sandals.html">NIKE</a></li>
                                        <li><a href="sandals.html">ADIDAS</a></li>
                                        <li><a href="sandals.html">JORDAN</a></li>
