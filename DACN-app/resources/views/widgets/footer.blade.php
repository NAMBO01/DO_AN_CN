<div class="footer">
            ...
            <div class="col-md-3 w3_footer_grid">
                ...
                <ul class="address">
                    ...
                    <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a
                            href="mailto:hainam011201@gmail@example.com">hainam011201@gmail.com</a></li>
                    <li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>037896868</li>
                </ul>
            </div>
            <div class="col-md-3 w3_footer_grid">
                <h3>Information</h3>
    ...
    <div class="footer-copy">
        ...
        <div class="container">
            <p>&copy; 2016 BÁO STORE Fashion. All rights reserved | Design by <a
